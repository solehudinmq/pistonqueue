...
dead_letter.subscribe(topic: 'topic_io_medium_failure', task_type: :io_bound_medium, group: 'group-7', consumer: 'consumer-7') do |original_id, original_data, error, failed_at|
