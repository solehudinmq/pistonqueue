...
dead_letter.subscribe(topic: 'topic_io_medium_failure', task_type: :io_bound_medium, is_archive: true, group: 'group-9', consumer: 'consumer-9') do |original_id, original_data, error, failed_at|
